...
class MovEquipVisitTercPassagDAO extends OCIAPEX {
    ...
    public function verifMovEquipPassag($idMovEquipProprioBD, $movEquipPassag) {
        ...
        $select = " SELECT "
                        . " COUNT(*) AS QTDE "
                    . " FROM "
                        . " PORTARIA_MOV_EQUIP_VISIT_TERC_PASSAG "
                    . " WHERE "
                        . " MOV_EQUIP_ID = " . $idMovEquipProprioBD
                        . " AND "
                        . " VISIT_TERC_ID = " . $movEquipPassag->idVisitTercMovEquipVisitTercPassag;
    ...
    public function insMovEquipPassag($idMovEquipProprioBD, $movEquipPassag) {
        ...
        $sql = "INSERT INTO PORTARIA_MOV_EQUIP_VISIT_TERC_PASSAG ("
                        . " MOV_EQUIP_ID "
                        . " , VISIT_TERC_ID "
                    . " ) "
                    . " VALUES ("
